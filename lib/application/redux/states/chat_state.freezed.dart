...
class _$ChatStateTearOff {
  ...
  _ChatState call({List<ChatMessage?>? chatMessages}) {
    return _ChatState(
      chatMessages: chatMessages,
    );
  }

  ChatState fromJson(Map<String, Object?> json) {
...
class _$_ChatState implements _ChatState {
  _$_ChatState({this.chatMessages});
  ...
  @override
  String toString() {
    return 'ChatState(chatMessages: $chatMessages)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(chatMessages));
  ...
  Map<String, dynamic> toJson() {
    return _$$_ChatStateToJson(this);
  }
}

abstract class _ChatState implements ChatState {
  factory _ChatState({List<ChatMessage?>? chatMessages}) = _$_ChatState;
